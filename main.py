...
def generate_problem():
    """Generates a math problem and its answer."""
...
hemligt_nummer = random.randint(1,10)

gissning = None

print("Välkommen till gissa numret-spelet!")
print("Jag har valt ett tal mellan 1 och 10. Kan du gissa vilket det är?")
print("Skriv 'q' när som helst för att avsluta.")

while True:
    gissning = input("Ange din gissning: ")

    if gissning.lower() == 'q':
        print("Du valde att avsluta programmet.")
        break
    ...
    try:
        ...
        print("Felaktig inmatning, skriv ett nummer mellan 1 och 10 eller 'q' för att avsluta.")
        continue
